...
function RichTextEditor({ value, onChange, placeholder }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-[#0E172B]/50">Tip: Highlight neighbourhoods, landmarks, and coverage details.</p>
    </div>
  );
}
        ...
        <div className="grid gap-6">
          ...
          <div className="rounded-2xl border border-[#0E172B]/10 bg-white p-6 shadow-lg">
            <div className="mb-3 flex items-center justify-between">
              ...
              <span className="text-xs font-semibold uppercase tracking-widest text-[#0E172B]/40">wysiwyg</span>
            </div>
            <RichTextEditor
              value={description}
              onChange={setDescription}
              placeholder="Describe coverage areas, response times, and local insights..."
            />
          </div>
          ...
          <div className="grid gap-4 rounded-2xl border border-[#0E172B]/10 bg-white p-6 shadow-lg md:grid-cols-2">
            <label className="flex flex-col gap-2">
              ...
              <input
                ...
                placeholder="Manchester Car Recovery | Next Towing"
              />
            </label>
        ...
        <div className="grid gap-6">
          <div className="rounded-2xl border border-[#0E172B]/10 bg-white p-6 shadow-lg">
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="text-xs text-[#0E172B]/50">
                  Upload one image. Local scenes or landmarks perform best.
                </p>
              </div>
              {imagePreview && (
                <button
            ...
            <label className="mt-4 flex cursor-pointer flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-[#0E172B]/20 bg-[#F8FAFC] p-6 text-center transition hover:border-[#FACC14] hover:bg-white">
              ...
              <span className="text-xs text-[#0E172B]/50">JPG or PNG • Keep under 2MB</span>
            </label>
          ...
          <div className="rounded-2xl border border-[#0E172B]/10 bg-white p-6 shadow-lg">
            ...
            <ul className="mt-3 space-y-2 text-sm text-[#0E172B]/70">
              <li>• Reference local areas and key routes in the description.</li>
              <li>• Keep the meta description between 140–160 characters.</li>
              <li>• Use an original photo for every location page.</li>
            </ul>
          </div>
        </div>
      </form>
